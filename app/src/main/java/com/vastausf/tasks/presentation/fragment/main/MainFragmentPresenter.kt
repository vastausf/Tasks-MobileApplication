...
constructor(
    ...
    fun loadProjects(offset: Int, limit: Int, parameters: ProjectDataSearch = ProjectDataSearch(), clean: Boolean = true) {
        ...
        tasksApiClient
            ...
            .subscribe(if (clean) this::onLoadProjectsSuccessClean else this::onLoadProjectsSuccess, this::onLoadProjectsError)
            .unsubscribeOnDestroy()
    }

    private fun onLoadProjectsSuccess(data: ProjectFindI) {
        viewState.bindProjectList(data.data, false)
    }

    private fun onLoadProjectsSuccessClean(data: ProjectFindI) {
